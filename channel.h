...
void removeallnodes(select_t* channel_list, size_t channel_count, sem_t* select_fuse, channel_t* successful_channel, int same);
void removesamenodes(select_t* channel_list, size_t channel_count, sem_t* select_fuse, channel_t* successful_channel);
void wakeselect(channel_t* channel, Node sendhead);
void wakeall(channel_t* channel, Node sendhead);
